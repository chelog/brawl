...
function mode.EndRound( data )
    ...
    if data.winner then
        ...
        brawl.NotifyAll( team.GetName( data.winner ) .. " squad won the round!" )
...
function mode.PlayerInitialSpawn( ply )
    ...
    timer.Simple(0,function()
        ...
        ply:SetTeam( t )
        brawl.NotifyAll( ply:Name() .. " joined " .. team.GetName(t) .. " squad" )
    end)
...
brawl.modes.register( "squad_el", mode )
