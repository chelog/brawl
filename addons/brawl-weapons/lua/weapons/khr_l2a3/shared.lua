...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_saker"] = { type = "Model", model = "models/cw2/attachments/556suppressor.mdl", bone = "WPN_Master", rel = "", pos = Vector(0, -0.401, 0.54), angle = Angle(0, 0, 0), size = Vector(0.699, 0.699, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
[1] = {header = "Barrel", offset = {-500, -320}, atts = {"md_saker"}},
