...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
	    ["md_pbs1"] = {model = "models/cw2/attachments/pbs1.mdl", bone = "PKM", pos = Vector(0.379, -21.299, -0.44), angle = Angle(0, 0, 0), size = Vector(0.699, 0.699, 0.699)},
...
SWEP.Attachments = {[4] = {header = "Optic", offset = {700, -350},  atts = {"md_fas2_eotech", "md_fas2_aimpoint", "md_uecw_csgo_acog"}},
	...
	[3] = {header = "Barrel", offset = {200, -400}, atts = {"md_pbs1"}},
