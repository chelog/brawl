...
if CLIENT then
	...
	["md_pbs1"] = { type = "Model", model = "models/cw2/attachments/pbs1.mdl", bone = "Vz58", rel = "", pos = Vector(16.5, 0, 1.557), angle = Angle(0, -90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.Attachments = {[3] = {header = "Sight", offset = {600, -400},  atts = {"odec3d_cmore_kry", "md_fas2_eotech", "md_fas2_aimpoint", "md_schmidt_shortdot", "md_uecw_csgo_acog"}},
	[2] = {header = "Barrel", offset = {100, -400}, atts = {"md_pbs1"}},
