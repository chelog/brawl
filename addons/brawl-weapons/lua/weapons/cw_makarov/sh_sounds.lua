CustomizableWeaponry:addFireSound("CW_MAKAROV_FIRE", {"weapons/cw_makarov/fire1.wav", "weapons/cw_makarov/fire2.wav"}, 1, 95, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_MAKAROV_FIRE_SUPPRESSED_PM", "weapons/cw_makarov/fire_suppressed_pm.wav", 1, 83, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_MAKAROV_FIRE_SUPPRESSED_PB", "weapons/cw_makarov/fire_suppressed_pb.wav", 1, 80, CHAN_STATIC)
