...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-2.273, 0, 1.12)
	SWEP.IronsightAng = Vector(-0.3, 0.06, 0)
    ...
    ["md_tundra9mm"] = { type = "Model", model = "models/cw2/attachments/9mmsuppressor.mdl", bone = "weapon", pos = Vector(.04, -1.24, 6), angle = Angle(0, 180, 90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
[2] = {header = "Barrel Extension", offset = {-450, -520}, atts = {"md_tundra9mm"}},
