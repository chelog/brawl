CustomizableWeaponry:addFireSound("CW_FIVESEVEN_FIRE", "weapons/cw_fiveseven/fire.wav", 1, 105, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_FIVESEVEN_FIRE_SUPPRESSED", "weapons/cw_fiveseven/fire_suppressed.wav", 1, 80, CHAN_STATIC)
