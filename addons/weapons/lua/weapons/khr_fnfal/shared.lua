...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_saker"] = { type = "Model", model = "models/cw2/attachments/556suppressor.mdl", bone = "Weapon", rel = "", pos = Vector(0, 7.791, -0.801), angle = Angle(0, 0, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.Attachments = {[3] = {header = "Sight", offset = {750, -50},  atts = {"md_microt1kh", "odec3d_cmore_kry", "md_fas2_eotech", "md_fas2_aimpoint", "md_schmidt_shortdot", "md_uecw_csgo_acog"}},
	[2] = {header = "Barrel", offset = {280, -300}, atts = {"md_saker"}},
...
SWEP.FireDelay = 0.0967741935483871
