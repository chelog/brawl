...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
	    ["md_saker"] = {model = "models/cw2/attachments/556suppressor.mdl", bone = "M60_Body", pos = Vector(0, 5.714, -2.1), angle = Angle(0, 0, 0), size = Vector(0.8, 0.8, 0.8)},
...
SWEP.Attachments = {[1] = {header = "Rail", offset = {-350, -600}, atts = {"md_anpeq15"}},
	[2] = {header = "Barrel", offset = {400, -700}, atts = {"md_saker"}},
