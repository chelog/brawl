...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-2.53, 1, 0.839)
	...
	["md_tundra9mm"] = { type = "Model", model = "models/cw2/attachments/9mmsuppressor.mdl", bone = "OTS-33_Low", rel = "", pos = Vector(-0, 4.675, 1.059), angle = Angle(0, 180, 0), size = Vector(0.55, 0.55, 0.55), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
[3] = {header = "Barrel Extension", offset = {-350, -600}, atts = {"md_tundra9mm"}},
