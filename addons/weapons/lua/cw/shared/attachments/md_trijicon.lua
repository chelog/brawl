local att = {}
att.name = "md_trijicon"
att.displayName = "Trijicon Reflex Sight"
att.displayNameShort = "Trijicon"
att.aimPos = {"TrijiconPos", "TrijiconAng"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("cw20_extras/icons/upgr_trijicon")
	...
	function att:drawReticle()
		...
		diff = self:getDifferenceToAimPos(self.TrijiconPos, self.TrijiconAng, att._reticleSize)
