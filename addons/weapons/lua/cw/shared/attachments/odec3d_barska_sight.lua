local att = {}
att.name = "odec3d_barska_sight"
att.displayName = "Barska sight"
att.displayNameShort = "Barska"
att.aimPos = {"BarskaRDPos", "BarskaRDAng"}
att.FOVModifier = 15
att.isSight = true
att.colorType = CustomizableWeaponry.colorableParts.COLOR_TYPE_SIGHT

if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/odec3d_barska_sight")
	...
	function att:drawReticle()
		...
		diff = self:getDifferenceToAimPos(self.BarskaRDPos, self.BarskaRDAng, 1)
