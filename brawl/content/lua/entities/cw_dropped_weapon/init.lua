...
function ENT:Use(activator, caller)
	...
	if canGetWeapon then -- give the weapon if possible
		...
		local oldAmmo1 = activator:GetAmmoCount( self.AmmoType1 )
		local oldAmmo2 = activator:GetAmmoCount( self.AmmoType2 )
		activator:SetAmmo( oldAmmo1 + self.Ammo1 + self.Clip1, self.AmmoType1 )
		activator:SetAmmo( oldAmmo2 + self.Ammo2 + self.Clip2, self.AmmoType2 )
		self:Remove()
	end
