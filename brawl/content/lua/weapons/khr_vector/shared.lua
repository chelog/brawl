...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_cobram2"] = { type = "Model", model = "models/cw2/attachments/cobra_m2.mdl", bone = "KrissBodyPart", rel = "", pos = Vector(-0.101, -9, 1), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
[1] = {header = "Barrel", offset = {-500, -250}, atts = {"md_cobram2"}},
