CustomizableWeaponry:addFireSound("CW_G36C_FIRE", "weapons/cw_g36c/fire.wav", 1, 110, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_G36C_FIRE_SUPPRESSED", "weapons/cw_g36c/fire_suppressed.wav", 1, 92, CHAN_STATIC)
