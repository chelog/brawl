...
if CLIENT then
    ...
    ["md_tundra9mm"] = { type = "Model", model = "models/cw2/attachments/9mmsuppressor.mdl", bone = "weapon", pos = Vector(0, -1.923, 6), angle = Angle(0, 0, 90), size = Vector(0.49, 0.49, 0.49), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
[2] = {header = "Barrel Extension", offset = {-350, -550}, atts = {"md_tundra9mm"}},
