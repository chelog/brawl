...
if CLIENT then
	...
	["md_tundra9mm"] = { type = "Model", model = "models/cw2/attachments/9mmsuppressor.mdl", bone = "Gun", rel = "", pos = Vector(0.075, 5.44, 1.23), angle = Angle(0, 180, 0), size = Vector(0.55, 0.55, 0.55), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.Attachments = {[2] = {header = "Barrel Extension", offset = {-350, -550}, atts = {"md_tundra9mm"}},
