...
if CLIENT then
	...
	["md_tundra9mm"] = { type = "Model", model = "models/cw2/attachments/9mmsuppressor.mdl", bone = "usp_main", rel = "", pos = Vector(7.3, -0.977, -0.82), angle = Angle(0, -90, 0), size = Vector(0.649, 0.649, 0.649), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
[2] = {header = "Barrel Extension", offset = {-450, -550}, atts = {"md_tundra9mm"}},
