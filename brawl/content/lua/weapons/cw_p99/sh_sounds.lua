CustomizableWeaponry:addFireSound("CW_P99_FIRE", "weapons/cw_p99/fire.wav", 1, 107, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_P99_FIRE_SUPPRESSED", "weapons/cw_p99/fire_suppressed.wav", 1, 95, CHAN_STATIC)
