...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-1.654, 0, 0.56)
	SWEP.IronsightAng = Vector(0.4, 0.02, 0)
	...
	["md_pbs1"] = {model = "models/cw2/attachments/pbs1.mdl", bone = "Base", pos = Vector(-15.905, 0.189, -0.991), angle = Angle(0, 90, 0), size = Vector(0.755, 0.755, 0.755)},
