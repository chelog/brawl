...
if CLIENT then
	...
	["md_cobram2"] = { type = "Model", model = "models/cw2/attachments/cobra_m2.mdl", bone = "p_frame", rel = "", pos = Vector(0.059, 17.7, 2.4), angle = Angle(-180, -90, 180), size = Vector(2, 2, 2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
[2] = {header = "Barrel Extension", offset = {-350, -550}, atts = {"md_cobram2"}},
