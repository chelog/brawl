CustomizableWeaponry:addFireSound("CW_M1911_FIRE", "weapons/cw_m1911/fire.wav", 1, 105, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_M1911_FIRE_SUPPRESSED", "weapons/cw_m1911/fire_suppressed.wav", 1, 85, CHAN_STATIC)
