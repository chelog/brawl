...
if CLIENT then
	...
	["md_saker"] = { type = "Model", model = "models/cw2/attachments/556suppressor.mdl", bone = "RSASS", rel = "", pos = Vector(2.49, -12.4, -4.45), angle = Angle(0, 180, 0), size = Vector(0.699, 0.699, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
[3] = {header = "Barrel", offset = {180, -400}, atts = {"md_saker"}},
