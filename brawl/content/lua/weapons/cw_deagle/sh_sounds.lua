CustomizableWeaponry:addFireSound("CW_DEAGLE_FIRE", "weapons/cw_deagle/fire.wav", 1, 115, CHAN_STATIC)
CustomizableWeaponry:addFireSound("CW_DEAGLE_FIRE_SUPPRESSED", "weapons/cw_deagle/fire_suppressed.wav", 1, 100, CHAN_STATIC)
