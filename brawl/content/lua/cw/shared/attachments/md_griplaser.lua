local att = {}
att.name = "md_griplaser"
att.displayName = "Grip Laser"
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/md_griplaser")
	...
	function att:elementRender()
		local model = self.AttachmentModelsVM.md_griplaser.ent
